...
export const COSMOS_ACCOUNT_ADDRESS_SET = 'COSMOS_ACCOUNT_ADDRESS_SET';
...
export const COSMOS_BALANCE_FETCH_IN_PROGRESS = 'COSMOS_BALANCE_FETCH_IN_PROGRESS';
export const COSMOS_BALANCE_FETCH_SUCCESS = 'COSMOS_BALANCE_FETCH_SUCCESS';
export const COSMOS_BALANCE_FETCH_ERROR = 'COSMOS_BALANCE_FETCH_ERROR';
...
export const DISCONNECT_COSMOS_SET = 'DISCONNECT_COSMOS_SET';

export const SIGN_IBC_TX_IN_PROGRESS = 'SIGN_IBC_TX_IN_PROGRESS';
export const SIGN_IBC_TX_SUCCESS = 'SIGN_IBC_TX_SUCCESS';
export const SIGN_IBC_TX_ERROR = 'SIGN_IBC_TX_ERROR';
